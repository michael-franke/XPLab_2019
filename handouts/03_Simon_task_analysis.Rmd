...
```{r}
prob_cc_lessthan_ii <- mean(correct_congruent < incorrect_incongruent)
```
 
**Homework: What does this value mean? Email the tutors your response by Thursday May 9, 09:59**
